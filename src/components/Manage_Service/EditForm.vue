  ...
  <div class="card">
    <div class="card-body">
      <div class="container" style="padding: 20px 70px;">
        <div class="row">
          <div class="col-10">
            <h1 class="d-flex justify-content-center">Chỉnh Sửa Dịch Vụ</h1>
          </div>
          <div class="col-2">
          ...
          <div class="mb-3 mt-3">
            <div class="p=1 d-flex align-items-center">
              ...
              <label class="text-center">
                <input class="toggle-checkbox" type="checkbox" name="status" :checked="serviceLocal.status === 'on'"
                  @change="updateStatus" />
...
export default {
  ...
  data() {
    ...
    const serviceCopy = JSON.parse(JSON.stringify(this.service));

    return {
      serviceLocal: serviceCopy,
      serviceFormSchema,
  ...
  methods: {
    updateStatus() {
      this.serviceLocal.status = this.serviceLocal.status === 'on' ? 'off' : 'on';
    },
    submitService() {
