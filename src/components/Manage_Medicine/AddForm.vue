  ...
  <div class="card">
    <div class="card-body">
      <div class="container" style="padding: 20px 70px;">
        <div class="row">
          <div class="col-10">
            <h1 class="d-flex justify-content-center">Thêm Thuốc Mới</h1>
          </div>
          <div class="col-2">
        ...
        <Form @submit="submitMedicine" :validation-schema="medicineFormSchema">
          ...
          <div class="mb-3 mt-3">
            ...
            <Field name="nhaCungCap" type="text" class="form-control" v-model="medicineLocal.nhaCungCap" required placeholder="Nhập vào nhà cung cấp thuốc"/>
