                                    ...
                                    <Form @submit="submitLogin" :validation-schema="loginFormSchema">
                                        <div class="mb-3">
                                            ...
                                            <Field class="form-control form-control-lg" type="email" name="email"
                                                placeholder="Enter your email" v-model="loginLocal.email"
                                                autocomplete="on" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <Field class="form-control form-control-lg" :type="passwordType"
                                                    name="password" placeholder="Enter your password"
                                                    v-model="loginLocal.password" autocomplete="on" />
